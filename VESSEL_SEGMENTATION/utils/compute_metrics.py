...
LABEL_PATH = os.path.join(GLOBAL_PATH,'DATA','DATASET1','processed','results','figures','labels_reversed')
...
if __name__ == '__main__':
    ...
    csv_filename = f"OPTICAL_FLOW/segmentation/results/data/seg_metrics1.csv"
